          ...
          <CardContent className="pt-4">
            <div className="flex items-start space-x-3">
              <Avatar className="h-10 w-10">
                <AvatarImage src={tweet.tweetAuthorProfileImageUrl} alt={tweet.tweetAuthorDisplayName} />
                <AvatarFallback>{tweet.tweetAuthorDisplayName.charAt(0)}</AvatarFallback>
              </Avatar>
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between">
                  <p className="text-sm font-bold text-gray-200 truncate">{tweet.tweetAuthorDisplayName}</p>
                ...
                <p className="text-sm text-gray-500">@{tweet.tweetAuthorDisplayName.split(" ")[0].toLowerCase()}</p>
              </div>
            </div>
